...
import type {
  KnowledgeSchedule,
  KnowledgeSchedulerDependencies,
  KnowledgeSynchronizationCommand,
  SchedulerRunResult,
} from "./types.js";

function occurrenceKey(schedule: KnowledgeSchedule): string {
...
export class KnowledgeScheduler {
  public constructor(
    private readonly dependencies: KnowledgeSchedulerDependencies,
  ) {
...
export function knowledgeScheduleOccurrenceKey(
  schedule: KnowledgeSchedule,
): string {
